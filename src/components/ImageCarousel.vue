      ...
      <div class="content">
        <div class="card">
          <div class="card-content">
            ...
            <div class="media-icons gap-5">
              <i><remix-icon icon="world" :size="20"></remix-icon></i>
              <i><remix-icon icon="user" :size="20"></remix-icon></i>
              <i><remix-icon icon="lupa" :size="20"></remix-icon></i>
            </div>
